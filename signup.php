...
<body>
	...
	<div class = "container col-lg-4 col-md-4 col-sm-8 item-container text-center align-center" id="signUpDiv">
		...
		<form id="signUpForm" action="register.php" method="post" class="input-form text-left" onsubmit="return validateSignUpForm()">
			...
			<label for="age"  style="width:140px">Age:</label> <input id="age" type="text" placeholder="e.g. 19"> <br><br>
